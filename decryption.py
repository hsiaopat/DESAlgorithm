...
def main():
    ...
    roundKeys = round_keys(binary_key)

    print("Generated Round Keys:")
    for i, key in enumerate(roundKeys, 1):
        print(f"Round {i}: {key}")
...
# Print output of f function and LnRn in each iteration
    ...
    for i in range(16):
        f_output = f_function(LnRn[1], roundKeys[i])  # Replace with actual f function
        print(f"Iteration {i + 1}: \n F={f_output}, LnRn={LnRn}\n\n")
